...
st.title("📬 Captured Alerts")
st.caption(
    "Deals captured from seats.aero alert emails before the Deal Finder replaced them (alerts are "
    "off, so this list no longer grows). Top Deals is the live view."
)
